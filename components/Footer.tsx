    ...
    <footer className="bg-slate-900 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Comer's BBQ & Catfish</h3>
            <p className="text-slate-300">Quality restaurant services you can trust.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-2">
                ...
                <span>(903) 555-0567</span>
              </li>
              <li className="flex items-start space-x-2">
                <MapPin className="w-5 h-5 mt-0.5" />
                <span>888 Smokehouse Lane, Carthage, TX 75633</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-700 mt-8 pt-8 text-center text-slate-400">
          <p>&copy; {new Date().getFullYear()} Comer's BBQ & Catfish. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
